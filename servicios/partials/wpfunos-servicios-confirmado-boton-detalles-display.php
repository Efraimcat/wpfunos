			...
			<div class="elementor-widget-wrap">
				<div class="wpfunos-botones-resultados" style=" margin-right: 10px; ">
					<div class="wpfunos-boton-llamada" style=" margin-right: 10px; ">
						<form id="wpfunos-servicios-confirmado-boton-detalles" target="POPUPW" action="<?php echo get_option('wpfunos_paginaDetalles'); ?>" method="get" onsubmit="POPUPW = window.open('about:blank', 'POPUPW', 'width=600, height=400, top=400, left=600');">
