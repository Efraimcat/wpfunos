...
<table style="width:100%">
	...
	<tr>
		<td style="width:30%"> 
			<div id="chartContainer16" style="height: 400px; width: 100%"></div>	
		</td>
		<td style="width:5%"></td>
		<td style="width:30%">
			<div id="chartContainer17" style="height: 400px; width: 100%"></div>		
		</td>
		<td style="width:5%"></td>
		<td style="width:30%">
			<div id="chartContainer18" style="height: 400px; width: 100%"></div>		
		</td>
	</tr>
</table>
<hr/>
...
<table style="width:100%">	
	...
	<tr>
		<td style="width:30%"> 
			<div id="chartContainer19" style="height: 400px; width: 100%"></div>		
		</td>
		<td style="width:5%"></td>
		<td style="width:30%"> 
...
<table style="width:100%">
	...
	<tr>
		<td style="width:30%"> 
			<div id="chartContainer20" style="height: 400px; width: 100%"></div>	
		</td>
		<td style="width:5%"></td>
		<td style="width:30%"> 
...
<table style="width:100%">	
	...
	<tr>
		<td style="width:30%"> 
			<div id="chartContainer21" style="height: 400px; width: 100%"></div>		
		</td>
		<td style="width:5%"></td>
		<td style="width:30%"> 
			<div id="chartContainer14" style="height: 400px; width: 100%"></div>		
		</td>
		<td style="width:5%"></td>
		<td style="width:30%">
			<div id="chartContainer15" style="height: 400px; width: 100%"></div>		
		</td>
	</tr>
</table>
<hr/>
<h3><?php esc_html_e( 'SERVICIOS', 'wpfunos' )?></h3>
<table style="width:100%">	
...
<hr/>
<h3><?php esc_html_e( 'CÓDIGOS POSTALES', 'wpfunos' )?></h3>
<table style="width:100%">	
	<tr><td colspan="3"><hr/></td></tr>
	<tr>
		<td style="width:47%"> 
