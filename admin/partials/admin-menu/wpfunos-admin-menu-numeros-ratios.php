...
<table>
  <tr>
    ...
    <th style="width:25px;"></th><th colspan="3"><h2>Datos/Ubicación</h2></th>
  ...
  <tr>
    ...
    <td></td><td style="text-align: right;"><?php echo $ratio_UbiEnt_mes_ant; ?></td>
    <td></td><td>Ratio mes anterior (<?php echo $displaymesant;?>):</td>
    <td></td><td style="text-align: right;"><?php echo $ratio_DatUbi_mes_ant; ?></td>
    <td></td><td>Ratio mes anterior (<?php echo $displaymesant;?>):</td>
    <td></td><td style="text-align: right;"><?php echo $ratio_DatEnt_mes_ant; ?></td>
  </tr>
  <tr>
    <td>Ratio mes (<?php echo $displaymes;  ?>):</td>
    <td></td><td style="text-align: right;"><?php echo $ratio_UbiEnt_mes; ?></td>
    <td></td><td>Ratio mes (<?php echo $displaymes;  ?>):</td>
    <td></td><td style="text-align: right;"><?php echo $ratio_DatUbi_mes; ?></td>
    <td></td><td>Ratio mes (<?php echo $displaymes;  ?>):</td>
    <td></td><td style="text-align: right;"><?php echo $ratio_DatEnt_mes; ?></td>
  </tr>
  <tr>
    <td>Ratio semana anterior (<?php echo $displaysemanaant;  ?>):</td>
    <td></td><td style="text-align: right;"><?php echo $ratio_UbiEnt_semana_ant; ?></td>
    <td></td><td>Ratio semana anterior (<?php echo $displaysemanaant;  ?>):</td>
    <td></td><td style="text-align: right;"><?php echo $ratio_DatUbi_semana_ant; ?></td>
    <td></td><td>Ratio semana anterior (<?php echo $displaysemanaant;  ?>):</td>
    <td></td><td style="text-align: right;"><?php echo $ratio_DatEnt_semana_ant; ?></td>
  </tr>
  <tr>
    <td>Ratio semana (<?php echo $displaysemana;  ?>):</td>
    <td></td><td style="text-align: right;"><?php echo $ratio_UbiEnt_semana; ?></td>
    <td></td><td>Ratio semana (<?php echo $displaysemana;  ?>):</td>
    <td></td><td style="text-align: right;"><?php echo $ratio_DatUbi_semana; ?></td>
    <td></td><td>Ratio semana (<?php echo $displaysemana;  ?>):</td>
    <td></td><td style="text-align: right;"><?php echo $ratio_DatEnt_semana; ?></td>
  </tr>
  <tr>
    <td>Ratio ayer:</td>
  ...
  <tr>
    ...
    <td></td><td style="text-align: right;"><?php echo $ratio_DatUbi_24h; ?></td>
    <td></td><td>Ratio hoy:</td>
