...
if( $post_list ){
  ...
  //$csv_output = 'ID,Tipo,Status,Titulo,Nombre,Direccion,Correo,Telefono,CategoriaProvincia,CategoriaPoblacion,Poblacion,CodigosProvincia,Funerarias,StreetView,Carrusel,         Latitud,Longitud,Imagenes,        ImagenDestacada,Landings,Servicios,Shortcode,     URLLandings,Extracto';
  $csv_output = 'ID,Tipo,Status,Titulo,Nombre,Direccion,Correo,Telefono,CategoriaProvincia,CategoriaPoblacion,Poblacion,CodigosProvincia,Funerarias,StreetView,Carrusel,ImagenDestacada,Landings,Servicios,Shortcode';
  $csv_output .= "\n";
  foreach ( $post_list as $post ){
    ...
    //$csv_output = 'ID,Tipo,Status,Titulo,Nombre,Direccion,Correo,Telefono,CategoriaProvincia,CategoriaPoblacion,Poblacion,CodigosProvincia,Funerarias,StreetView,Carrusel,
    //ImagenDestacada,Landings,Servicios,Shortcode';
