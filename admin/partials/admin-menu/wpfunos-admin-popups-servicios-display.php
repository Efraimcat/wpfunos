...
<div class="wrap">
  ...
  <h2><?php esc_html_e( 'Ajustes popups servicios WpFunos', 'wpfunos' ); ?></h2>
  <div style="margin-top: 10px;margin-bottom: 10px;"><?php echo date_i18n( 'd F Y H:i:s', current_time( 'timestamp', 0 ) );?></div>
  <hr/>
  <?php settings_errors(); ?>
  <form method="POST" action="options.php">
    <?php
    settings_fields('wpfunos_popupservicios_settings');
    do_settings_sections('wpfunos_popupservicios_settings');
    ?>
    <hr />
    <?php submit_button(); ?>
  </form>
