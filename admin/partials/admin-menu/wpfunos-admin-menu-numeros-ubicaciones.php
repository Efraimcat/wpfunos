	...
	<?php for ($x = 0; $x <= 10; $x++) { ?>
		<tr>
			<?php 
				...
				if ( $x== 3 ) echo '<td>Ubicaciones ayer: </td><td>' . $this->wpfunos_stats_date( "ubicaciones_wpfunos", "ayer" ) . '</td>';
				if ( $x== 4 ) echo '<td>Ubicaciones hoy: </td><td>' . $this->wpfunos_stats_date( "ubicaciones_wpfunos", "day" ) . '</td>';
				if ( $x >= 5 ) echo '<td></td><td></td>';
			?>
