...
$customPostTypeArgs = array(
  'label' => esc_html__('Provincias', 'wpfunos'),
  'labels'=>
  array(
    ...
    'menu_name' => esc_html__('Provincias', 'wpfunos'),
    'name_admin_bar' => esc_html__('Provincias', 'wpfunos'),
  ),
  'public'=>false,
  'description' => esc_html__('Provincias', 'wpfunos'),
...
register_post_type( 'provincias_wpfunos', $customPostTypeArgs );
