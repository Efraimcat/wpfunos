...
add_settings_section(
  ...
  '<span id="wpfunos-llamen-aseguradora">Correo Lead a la aseguradora. Botón "Que me llamen"</span>',    // Title to be displayed on the administration page
...
add_settings_field(
  ...
  'Activar Correo Boton 1 Lead Aseguradora <h6 style="font-style: italic;font-weight: 400;font-size: 12px;">(wpfunos_activarCorreoBoton1LeadAseguradora)</h6>',
...
add_settings_field(
  ...
  'Mail Correo Cco Boton 1 Lead Aseguradora <h6 style="font-style: italic;font-weight: 400;font-size: 12px;">(wpfunos_mailCorreoCcoBoton1LeadAseguradora)</h6>',
  array( $this, 'wpfunos_render_settings_field' ),
  'wpfunos_mail_settings',
  'wpfunos_mail10_section',
...
add_settings_field(
  ...
  'Mail Correo Bcc Boton 1 Lead Aseguradora <h6 style="font-style: italic;font-weight: 400;font-size: 12px;">(wpfunos_mailCorreoBccBoton1LeadAseguradora)</h6>',
  array( $this, 'wpfunos_render_settings_field' ),
  'wpfunos_mail_settings',
  'wpfunos_mail10_section',
...
add_settings_field(
  ...
  'Asunto Correo Boton 1 Lead Aseguradora <h6 style="font-style: italic;font-weight: 400;font-size: 12px;">(wpfunos_asuntoCorreoBoton1LeadAseguradora)</h6>',
  array( $this, 'wpfunos_render_settings_field' ),
  'wpfunos_mail_settings',
  'wpfunos_mail10_section',
...
add_settings_field(
  ...
  'Mensaje Correo Boton 1 Lead Aseguradora <h6 style="font-style: italic;font-weight: 400;font-size: 12px;">(wpfunos_mensajeCorreoBoton1LeadAseguradora)</h6>',
