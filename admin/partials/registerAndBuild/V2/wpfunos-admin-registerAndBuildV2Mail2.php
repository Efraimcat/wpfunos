...
add_settings_field(
  ...
  'Dirección correo Cco botón "Quiero que me llamen" <h6 style="font-style: italic;font-weight: 400;font-size: 12px;">(wpfunos_mailCorreoCcoBoton1v2Admin)</h6>',
  array( $this, 'wpfunos_render_settings_field' ),
  'wpfunos_mail_settings',
  'wpfunos_mailadminboton1v2_section',
...
add_settings_field(
  ...
  'Dirección correo Bcc botón "Quiero que me llamen" <h6 style="font-style: italic;font-weight: 400;font-size: 12px;">(wpfunos_mailCorreoBccBoton1v2Admin)</h6>',
  array( $this, 'wpfunos_render_settings_field' ),
  'wpfunos_mail_settings',
  'wpfunos_mailadminboton1v2_section',
...
add_settings_field(
  ...
  'Asunto correo administrador botón "Quiero que me llamen" <h6 style="font-style: italic;font-weight: 400;font-size: 12px;">(wpfunos_asuntoCorreoBoton1v2Admin)</h6>',
  array( $this, 'wpfunos_render_settings_field' ),
  'wpfunos_mail_settings',
  'wpfunos_mailadminboton1v2_section',
...
add_settings_field(
  ...
  'Mensaje correo administrador botón "Quiero que me llamen" <h6 style="font-style: italic;font-weight: 400;font-size: 12px;">(wpfunos_mensajeCorreoBoton1v2Admin)</h6>',
