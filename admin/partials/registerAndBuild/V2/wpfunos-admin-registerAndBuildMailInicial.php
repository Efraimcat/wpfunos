...
add_settings_field(
  ...
  array('type' => 'input','subtype' => 'text','id' => 'wpfunos_mailCorreoCcoPopup','name' => 'wpfunos_mailCorreoCcoPopup','required' => 'true','get_options_list' => '','value_type' => 'normal','wp_data' => 'option')
);

register_setting('wpfunos_mail_settings_v3', 'wpfunos_mailCorreoCcoPopup');
