...
add_settings_section(
  ...
  '<span id="wpfunos-llamar-admin-v2">Correo funeraria botón "Llamar"</span>',               // Title to be displayed on the administration page
...
add_settings_field(
  ...
  'Activar correo funeraria botón "Llamar" <h6 style="font-style: italic;font-weight: 400;font-size: 12px;">(wpfunos_activarCorreoBoton2v2Admin)</h6>',
...
add_settings_field(
  ...
  'Dirección correo funeraria Cco botón "Llamar" <h6 style="font-style: italic;font-weight: 400;font-size: 12px;">(wpfunos_mailCorreoCcoBoton2v2Admin)</h6>',
  array( $this, 'wpfunos_render_settings_field' ),
  'wpfunos_mail_settings_v3',
  'wpfunos_mailadminboton2v2_section',
...
add_settings_field(
  ...
  'Dirección correo funeraria Bcc botón "Llamar" <h6 style="font-style: italic;font-weight: 400;font-size: 12px;">(wpfunos_mailCorreoBccBoton2v2Admin)</h6>',
  array( $this, 'wpfunos_render_settings_field' ),
  'wpfunos_mail_settings_v3',
  'wpfunos_mailadminboton2v2_section',
...
add_settings_field(
  ...
  'Asunto correo funeraria botón "Llamar" <h6 style="font-style: italic;font-weight: 400;font-size: 12px;">(wpfunos_asuntoCorreoBoton2v2Admin)</h6>',
  array( $this, 'wpfunos_render_settings_field' ),
  'wpfunos_mail_settings_v3',
  'wpfunos_mailadminboton2v2_section',
...
add_settings_field(
  ...
  'Mensaje correo funeraria botón "Llamar" <h6 style="font-style: italic;font-weight: 400;font-size: 12px;">(wpfunos_mensajeCorreoBoton2v2Admin)</h6>',
