...
add_settings_section(
  ...
  '<span id="wpfunos-llamar-admin-v2">Correo al administrador botón "Llamar"</span>',               // Title to be displayed on the administration page
...
add_settings_field(
  ...
  'Activar correo al administrador botón "Llamar" <h6 style="font-style: italic;font-weight: 400;font-size: 12px;">(wpfunos_activarCorreoBoton2v2Admin)</h6>',
