 ...
 */
 add_settings_section('wpfunos_directorio_section',    	// ID used to identify this section and with which to register options
 ...
 add_settings_field($this->plugin_name . '_PlantillaDirectorioTanatorios',
