...
if( $post_list ){
  ...
  $file = $upload_dir['basedir'] . '/wpfunos-exports/export-tanatorios-directorio-'. $now->format("d-m-Y-H-i") . '.csv';
  $filedownload = home_url(). '/wp-content/uploads/wpfunos-exports/export-tanatorios-directorio-'. $now->format("d-m-Y-H-i") . '.csv';
  $open = fopen( $file, "w" );
