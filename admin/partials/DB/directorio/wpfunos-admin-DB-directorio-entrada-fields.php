...
$entradaDirectorioFAQUbicacion = preg_replace('/^[ \t]*[\r\n]+/m', '', wp_kses_post($_POST['wpfunos_entradaDirectorioFAQUbicacion']));
$entradaDirectorioFAQHorario = preg_replace('/^[ \t]*[\r\n]+/m', '', wp_kses_post($_POST['wpfunos_entradaDirectorioFAQHorario']));
$entradaDirectorioFAQTransporte = preg_replace('/^[ \t]*[\r\n]+/m', '', wp_kses_post($_POST['wpfunos_entradaDirectorioFAQTransporte']));
$entradaDirectorioFAQCoche = preg_replace('/^[ \t]*[\r\n]+/m', '', wp_kses_post($_POST['wpfunos_entradaDirectorioFAQCoche']));
...
update_post_meta($post_id, 'wpfunos_entradaDirectorioFAQUbicacion', $entradaDirectorioFAQUbicacion);
update_post_meta($post_id, 'wpfunos_entradaDirectorioFAQHorario', $entradaDirectorioFAQHorario);
update_post_meta($post_id, 'wpfunos_entradaDirectorioFAQTransporte', $entradaDirectorioFAQTransporte);
update_post_meta($post_id, 'wpfunos_entradaDirectorioFAQCoche', $entradaDirectorioFAQCoche);
