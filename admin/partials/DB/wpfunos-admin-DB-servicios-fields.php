...
$servicioZona = sanitize_text_field( $_POST['wpfunos_servicioZona'] );
...
$servicioServicioFunerario = sanitize_text_field( $_POST['wpfunos_servicioServicioFunerario'] );
$servicioPlanesSinPrecio = sanitize_text_field( $_POST['wpfunos_servicioPlanesSinPrecio'] );
...
update_post_meta($post_id, 'wpfunos_servicioZona', $servicioZona);
...
update_post_meta($post_id, 'wpfunos_servicioServicioFunerario', $servicioServicioFunerario);
update_post_meta($post_id, 'wpfunos_servicioPlanesSinPrecio', $servicioPlanesSinPrecio);
