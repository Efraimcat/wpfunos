...
<div class="funerarias_wpfunos_containers">
  <ul class="funerarias_wpfunos_data_metabox">
    ...
    <li class="funerarias_wpfunos_list">
      <label for="<?php esc_html_e($this->plugin_name . '_funerariaTelefono' ); ?>"> <?php esc_html_e('Teléfono', 'wpfunos');?></label> 
    ...
    <li class="funerarias_wpfunos_list">
      <label for="<?php esc_html_e($this->plugin_name . '_funerariaDireccion' ); ?>"> <?php esc_html_e('Dirección', 'wpfunos');?></label> 
    ...
    <li class="funerarias_wpfunos_list">
      <label for="<?php esc_html_e($this->plugin_name . '_funerariaValoracion' ); ?>"> <?php esc_html_e('Valoración', 'wpfunos');?></label> 
    ...
    <li class="funerarias_wpfunos_list">
      <label for="<?php esc_html_e($this->plugin_name . '_funerariaDescuentoGenerico' ); ?>"> <?php esc_html_e('Descuento genérico', 'wpfunos');?></label> 
