...
?><ul class="usuarios_wpfunos_data_metabox">
  ...
  <li class="usuarios_wpfunos_list">
    <label for="<?php esc_html_e($this->plugin_name . '_userAPITipo' ); ?>"> 
      <?php esc_html_e('Tipo API', 'wpfunos');?>
    </label> 
    <?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_userAPITipo','name' => $this->plugin_name . '_userAPITipo','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID,'disabled' => '' ));?>
  </li>
  <li class="usuarios_wpfunos_list">
    <label for="<?php esc_html_e($this->plugin_name . '_userAPIBody' ); ?>"> 
      <?php esc_html_e('Body API', 'wpfunos');?>
    </label>
    <?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_userAPIBody','name' => $this->plugin_name . '_userAPIBody','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID,'disabled' => '' )); ?>
  </li>
  <li class="usuarios_wpfunos_list">
    <label for="<?php esc_html_e($this->plugin_name . '_userAPIMessage' ); ?>"> 
      <?php esc_html_e('Mensaje API', 'wpfunos');?>
    </label>
    <?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_userAPIMessage','name' => $this->plugin_name . '_userAPIMessage','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID,'disabled' => ''));?>
  </li>
  <li class="usuarios_wpfunos_list">
    <label for="<?php esc_html_e($this->plugin_name . '_userIP' ); ?>"> 
      <?php esc_html_e('IP', 'wpfunos');?>
    </label>
    <?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_userIP','name' => $this->plugin_name . '_userIP','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID,'disabled' => ''));?>
  </li>
  <li class="usuarios_wpfunos_list">
    <label for="<?php esc_html_e($this->plugin_name . '_userLAT' ); ?>">
      <?php esc_html_e('LAT', 'wpfunos');?>
    </label>
    <?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_userLAT','name' => $this->plugin_name . '_userLAT','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID,'disabled' => ''));?>
  </li>
  <li class="usuarios_wpfunos_list">
    <label for="<?php esc_html_e($this->plugin_name . '_userLNG' ); ?>"> 
      <?php esc_html_e('LNG', 'wpfunos');?>
    </label>
    <?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_userLNG','name' => $this->plugin_name . '_userLNG','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID,'disabled' => ''));?>
  </li>
  <li class="usuarios_wpfunos_list">
    <label for="<?php esc_html_e($this->plugin_name . '_userPluginVersion' ); ?>">
      <?php esc_html_e('version', 'wpfunos');?>
    </label>
    <?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_userPluginVersion','name' => $this->plugin_name . '_userPluginVersion','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID,'disabled' => ''));?>
  </li>
  <li class="ubicaciones_wpfunos_list">
    <label for="<?php esc_html_e($this->plugin_name . '_Dummy' ); ?>">
      <?php esc_html_e('', 'wpfunos');?>
    </label>
