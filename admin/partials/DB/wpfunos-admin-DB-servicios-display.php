...
?><ul class="servicios_wpfunos_data_metabox">
  ...
  <li class="servicios_wpfunos_list">
    <table>
      ...
      <tr>
        <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioLogo','name' => $this->plugin_name . '_servicioLogo','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7 ));?></td>
        <td style="width:5px;"></td>
        ...
        <td style="width:5px;"></td>
        <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioImagenPromo','name' => $this->plugin_name . '_servicioImagenPromo','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 14 )); ?></td>
      </tr>
    </table>
  </li>		
  <hr/>
  ...
  <table style="width:100%">
    ...
    <tr>
      ...
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDestino_1Descuento','name' => $this->plugin_name . '_servicioDestino_1Descuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDestino_1ProxPrecio','name' => $this->plugin_name . '_servicioDestino_1ProxPrecio','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>€</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDestino_1ProxDescuento','name' => $this->plugin_name . '_servicioDestino_1ProxDescuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
    </tr>
    <tr>
      <td>Incineración</td>
      ...
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDestino_2Descuento','name' => $this->plugin_name . '_servicioDestino_2Descuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDestino_2ProxPrecio','name' => $this->plugin_name . '_servicioDestino_2ProxPrecio','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>€</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDestino_2ProxDescuento','name' => $this->plugin_name . '_servicioDestino_2ProxDescuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
    </tr>
    <tr>
      <td>Traslado</td>
      ...
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDestino_3Descuento','name' => $this->plugin_name . '_servicioDestino_3Descuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDestino_3ProxPrecio','name' => $this->plugin_name . '_servicioDestino_3ProxPrecio','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>€</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDestino_3ProxDescuento','name' => $this->plugin_name . '_servicioDestino_3ProxDescuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
    </tr>
  </table>
  <hr/>
  ...
  <table style="width:100%">
    ...
    <tr>
      ...
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaud_1Descuento','name' => $this->plugin_name . '_servicioAtaud_1Descuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaud_1ProxPrecio','name' => $this->plugin_name . '_servicioAtaud_1ProxPrecio','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>€</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaud_1ProxDescuento','name' => $this->plugin_name . '_servicioAtaud_1ProxDescuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
    </tr>
    <tr>
      <td>Medio</td>
      ...
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaud_2Descuento','name' => $this->plugin_name . '_servicioAtaud_2Descuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaud_2ProxPrecio','name' => $this->plugin_name . '_servicioAtaud_2ProxPrecio','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>€</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaud_2ProxDescuento','name' => $this->plugin_name . '_servicioAtaud_2ProxDescuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
    </tr>
    <tr>
      <td>Premium</td>
      ...
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaud_3Descuento','name' => $this->plugin_name . '_servicioAtaud_3Descuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaud_3ProxPrecio','name' => $this->plugin_name . '_servicioAtaud_3ProxPrecio','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>€</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaud_3ProxDescuento','name' => $this->plugin_name . '_servicioAtaud_3ProxDescuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
    </tr>
    <tr>
      ...
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaudEcologico_1Descuento','name' => $this->plugin_name . '_servicioAtaudEcologico_1Descuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaudEcologico_1ProxPrecio','name' => $this->plugin_name . '_servicioAtaudEcologico_1ProxPrecio','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>€</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaudEcologico_1ProxDescuento','name' => $this->plugin_name . '_servicioAtaudEcologico_1ProxDescuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
    </tr>
    <tr>
      ...
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaudEcologico_2Descuento','name' => $this->plugin_name . '_servicioAtaudEcologico_2Descuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaudEcologico_2ProxPrecio','name' => $this->plugin_name . '_servicioAtaudEcologico_2ProxPrecio','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>€</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaudEcologico_2ProxDescuento','name' => $this->plugin_name . '_servicioAtaudEcologico_2ProxDescuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
    </tr>
    <tr>
      ...
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaudEcologico_3Descuento','name' => $this->plugin_name . '_servicioAtaudEcologico_3Descuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaudEcologico_3ProxPrecio','name' => $this->plugin_name . '_servicioAtaudEcologico_3ProxPrecio','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>€</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaudEcologico_3ProxDescuento','name' => $this->plugin_name . '_servicioAtaudEcologico_3ProxDescuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
    </tr>
  </table>
  <hr/>
  ...
  <table style="width:100%">
    ...
    <tr>
      ...
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioVelatorioDescuento','name' => $this->plugin_name . '_servicioVelatorioDescuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioVelatorioProxPrecio','name' => $this->plugin_name . '_servicioVelatorioProxPrecio','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>€</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioVelatorioProxDescuento','name' => $this->plugin_name . '_servicioVelatorioProxDescuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
    </tr>
    <tr>
      <td>Sin</td>
      ...
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioVelatorioNoDescuento','name' => $this->plugin_name . '_servicioVelatorioNoDescuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioVelatorioNoProxPrecio','name' => $this->plugin_name . '_servicioVelatorioNoProxPrecio','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>€</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioVelatorioNoProxDescuento','name' => $this->plugin_name . '_servicioVelatorioNoProxDescuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
    </tr>
  </table>
  <hr/>
  ...
  <table style="width:100%">
    ...
    <tr>
      ...
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDespedida_1Descuento','name' => $this->plugin_name . '_servicioDespedida_1Descuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDespedida_1ProxPrecio','name' => $this->plugin_name . '_servicioDespedida_1ProxPrecio','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>€</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDespedida_1ProxDescuento','name' => $this->plugin_name . '_servicioDespedida_1ProxDescuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
    </tr>
    <tr>
      <td>Civil</td>
      ...
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDespedida_2Descuento','name' => $this->plugin_name . '_servicioDespedida_2Descuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDespedida_2ProxPrecio','name' => $this->plugin_name . '_servicioDespedida_2ProxPrecio','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>€</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDespedida_2ProxDescuento','name' => $this->plugin_name . '_servicioDespedida_2ProxDescuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
    </tr>
    <tr>
      <td>Religiosa</td>
      ...
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDespedida_3Descuento','name' => $this->plugin_name . '_servicioDespedida_3Descuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDespedida_3ProxPrecio','name' => $this->plugin_name . '_servicioDespedida_3ProxPrecio','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>€</td>
      <td><?php $this->wpfunos_render_settings_field(array('type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDespedida_3ProxDescuento','name' => $this->plugin_name . '_servicioDespedida_3ProxDescuento','required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));?>%</td>
    </tr>
  </table>
  <hr/>
