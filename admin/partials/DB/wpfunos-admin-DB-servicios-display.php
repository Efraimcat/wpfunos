...
?><ul class="servicios_wpfunos_data_metabox">
 ...
 <table style="width:100%">
   <tr>
     <td>Tipo</td><td>Nombre</td><td>Precio</td><td>Comentario</td><td>Precio prox.</td><td>Descuento</td><td>Precio futuro</td><td>Descuento</td>
   </tr>
   <tr>
     <td>Entierro</td>
     <td><?php $this->wpfunos_render_settings_field(array(
     ...
     ?>%</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDestino_1FuturoPrecio','name' => $this->plugin_name . '_servicioDestino_1FuturoPrecio',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>€</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDestino_1FuturoDescuento','name' => $this->plugin_name . '_servicioDestino_1FuturoDescuento',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>%</td>
   </tr>
   <tr>
     ...
     ?>%</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDestino_2FuturoPrecio','name' => $this->plugin_name . '_servicioDestino_2FuturoPrecio',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>€</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDestino_2FuturoDescuento','name' => $this->plugin_name . '_servicioDestino_2FuturoDescuento',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>%</td>
   </tr>
   <tr>
     ...
     ?>%</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDestino_3FuturoPrecio','name' => $this->plugin_name . '_servicioDestino_3FuturoPrecio',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>€</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDestino_3FuturoDescuento','name' => $this->plugin_name . '_servicioDestino_3FuturoDescuento',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>%</td>
   </tr>
 </table>
 ...
 <table style="width:100%">
   <tr>
     <td>Tipo</td><td>Nombre</td><td>Precio</td><td>Descuento</td><td>Precio prox.</td><td>Descuento</td><td>Precio futuro</td><td>Descuento</td>
   </tr>
   <tr>
     <td>Económico</td>
     <td><?php $this->wpfunos_render_settings_field(array(
     ...
     ?>%</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaud_1FuturoPrecio','name' => $this->plugin_name . '_servicioAtaud_1FuturoPrecio',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>€</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaud_1FuturoDescuento','name' => $this->plugin_name . '_servicioAtaud_1FuturoDescuento',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>%</td>
   </tr>
   <tr>
     ...
     ?>%</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaud_2FuturoPrecio','name' => $this->plugin_name . '_servicioAtaud_2FuturoPrecio',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>€</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaud_2FuturoDescuento','name' => $this->plugin_name . '_servicioAtaud_2FuturoDescuento',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>%</td>
   </tr>
   <tr>
     ...
     ?>%</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaud_3FuturoPrecio','name' => $this->plugin_name . '_servicioAtaud_3FuturoPrecio',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>€</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaud_3FuturoDescuento','name' => $this->plugin_name . '_servicioAtaud_3FuturoDescuento',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>%</td>
   </tr>
   <tr>
     ...
     ?>%</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaudEcologico_1FuturoPrecio','name' => $this->plugin_name . '_servicioAtaudEcologico_1FuturoPrecio',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>€</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaudEcologico_1FuturoDescuento','name' => $this->plugin_name . '_servicioAtaudEcologico_1FuturoDescuento',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>%</td>
   </tr>
   <tr>
     ...
     ?>%</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaudEcologico_2FuturoPrecio','name' => $this->plugin_name . '_servicioAtaudEcologico_2FuturoPrecio',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>€</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaudEcologico_2FuturoDescuento','name' => $this->plugin_name . '_servicioAtaudEcologico_2FuturoDescuento',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>%</td>
   </tr>
   <tr>
     ...
     ?>%</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaudEcologico_3FuturoPrecio','name' => $this->plugin_name . '_servicioAtaudEcologico_3FuturoPrecio',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>€</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioAtaudEcologico_3FuturoDescuento','name' => $this->plugin_name . '_servicioAtaudEcologico_3FuturoDescuento',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>%</td>
   </tr>
 </table>
 ...
 <table style="width:100%">
   ...
   <tr>
     ...
     ?>%</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioVelatorioFuturoPrecio','name' => $this->plugin_name . '_servicioVelatorioFuturoPrecio',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>€</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioVelatorioFuturoDescuento','name' => $this->plugin_name . '_servicioVelatorioFuturoDescuento',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>%</td>
   </tr>
   <tr>
     ...
     ?>%</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioVelatorioNoFuturoPrecio','name' => $this->plugin_name . '_servicioVelatorioNoFuturoPrecio',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>€</td>
     <td><?php $this->wpfunos_render_settings_field(array(
       'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioVelatorioNoFuturoDescuento','name' => $this->plugin_name . '_servicioVelatorioNoFuturoDescuento',
        'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
     ?>%</td>
   </tr>
 </table>
 ...
 <table style="width:100%">
  ...
  <tr>
    ...
    ?>%</td>
    <td><?php $this->wpfunos_render_settings_field(array(
      'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDespedida_1FuturoPrecio','name' => $this->plugin_name . '_servicioDespedida_1FuturoPrecio',
       'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
    ?>€</td>
    <td><?php $this->wpfunos_render_settings_field(array(
      'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDespedida_1FuturoDescuento','name' => $this->plugin_name . '_servicioDespedida_1FuturoDescuento',
       'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
    ?>%</td>
  </tr>
  <tr>
    ...
    ?>%</td>
    <td><?php $this->wpfunos_render_settings_field(array(
      'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDespedida_2FuturoPrecio','name' => $this->plugin_name . '_servicioDespedida_2FuturoPrecio',
       'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
    ?>€</td>
    <td><?php $this->wpfunos_render_settings_field(array(
      'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDespedida_2FuturoDescuento','name' => $this->plugin_name . '_servicioDespedida_2FuturoDescuento',
       'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
    ?>%</td>
  </tr>
  <tr>
    ...
    ?>%</td>
    <td><?php $this->wpfunos_render_settings_field(array(
      'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDespedida_3FuturoPrecio','name' => $this->plugin_name . '_servicioDespedida_3FuturoPrecio',
       'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
    ?>€</td>
    <td><?php $this->wpfunos_render_settings_field(array(
      'type' => 'input','subtype' => 'text','id' => $this->plugin_name . '_servicioDespedida_3FuturoDescuento','name' => $this->plugin_name . '_servicioDespedida_3FuturoDescuento',
       'required' => 'required','get_options_list' => '','value_type' => 'normal','wp_data' => 'post_meta','post_id' => $post->ID, 'size' => 7));
    ?>%</td>
  </tr>
 </table>
 ...
 $notes_servicioDestino_1FuturoComentario = get_post_meta( $post->ID, $this->plugin_name . '_servicioDestino_1FuturoComentario', true );
 $args_servicioDestino_1FuturoComentario = array( 'textarea_name' => $this->plugin_name . '_servicioDestino_1FuturoComentario', );
 ...
 $notes_servicioDestino_2FuturoComentario = get_post_meta( $post->ID, $this->plugin_name . '_servicioDestino_2FuturoComentario', true );
 $args_servicioDestino_2FuturoComentario = array( 'textarea_name' => $this->plugin_name . '_servicioDestino_2FuturoComentario', );
 ...
 $notes_servicioDestino_3FuturoComentario = get_post_meta( $post->ID, $this->plugin_name . '_servicioDestino_3FuturoComentario', true );
 $args_servicioDestino_3FuturoComentario = array( 'textarea_name' => $this->plugin_name . '_servicioDestino_3FuturoComentario', );
 ...
 $notes_servicioAtaud_1FuturoComentario = get_post_meta( $post->ID, $this->plugin_name . '_servicioAtaud_1FuturoComentario', true );
 $args_servicioAtaud_1FuturoComentario = array( 'textarea_name' => $this->plugin_name . '_servicioAtaud_1FuturoComentario', );
 ...
 $notes_servicioAtaud_2FuturoComentario = get_post_meta( $post->ID, $this->plugin_name . '_servicioAtaud_2FuturoComentario', true );
 $args_servicioAtaud_2FuturoComentario = array( 'textarea_name' => $this->plugin_name . '_servicioAtaud_2FuturoComentario', );
 ...
 $notes_servicioAtaud_3FuturoComentario = get_post_meta( $post->ID, $this->plugin_name . '_servicioAtaud_3FuturoComentario', true );
 $args_servicioAtaud_3FuturoComentario = array( 'textarea_name' => $this->plugin_name . '_servicioAtaud_3FuturoComentario', );
 ...
 $notes_servicioAtaudEcologico_1FuturoComentario = get_post_meta( $post->ID, $this->plugin_name . '_servicioAtaudEcologico_1FuturoComentario', true );
 $args_servicioAtaudEcologico_1FuturoComentario = array( 'textarea_name' => $this->plugin_name . '_servicioAtaudEcologico_1FuturoComentario', );
 ...
 $notes_servicioAtaudEcologico_2FuturoComentario = get_post_meta( $post->ID, $this->plugin_name . '_servicioAtaudEcologico_2FuturoComentario', true );
 $args_servicioAtaudEcologico_2FuturoComentario = array( 'textarea_name' => $this->plugin_name . '_servicioAtaudEcologico_2FuturoComentario', );
 ...
 $notes_servicioAtaudEcologico_3FuturoComentario = get_post_meta( $post->ID, $this->plugin_name . '_servicioAtaudEcologico_3FuturoComentario', true );
 $args_servicioAtaudEcologico_3FuturoComentario = array( 'textarea_name' => $this->plugin_name . '_servicioAtaudEcologico_3FuturoComentario', );
 ...
 $notes_servicioVelatorioFuturoComentario = get_post_meta( $post->ID, $this->plugin_name . '_servicioVelatorioFuturoComentario', true );
 $args_servicioVelatorioFuturoComentario = array( 'textarea_name' => $this->plugin_name . '_servicioVelatorioFuturoComentario', );
 ...
 $notes_servicioVelatorioNoFuturoComentario = get_post_meta( $post->ID, $this->plugin_name . '_servicioVelatorioNoFuturoComentario', true );
 $args_servicioVelatorioNoFuturoComentario = array( 'textarea_name' => $this->plugin_name . '_servicioVelatorioNoFuturoComentario', );
 ...
 $notes_servicioDespedida_1FuturoComentario = get_post_meta( $post->ID, $this->plugin_name . '_servicioDespedida_1FuturoComentario', true );
 $args_servicioDespedida_1FuturoComentario = array( 'textarea_name' => $this->plugin_name . '_servicioDespedida_1FuturoComentario', );
 ...
 $notes_servicioDespedida_2FuturoComentario = get_post_meta( $post->ID, $this->plugin_name . '_servicioDespedida_2FuturoComentario', true );
 $args_servicioDespedida_2FuturoComentario = array( 'textarea_name' => $this->plugin_name . '_servicioDespedida_2FuturoComentario', );
 ...
 $notes_servicioDespedida_3FuturoComentario = get_post_meta( $post->ID, $this->plugin_name . '_servicioDespedida_3FuturoComentario', true );
 $args_servicioDespedida_3FuturoComentario = array( 'textarea_name' => $this->plugin_name . '_servicioDespedida_3FuturoComentario', );
 ...
 <li><label for="'.$this->plugin_name._servicioDestino_1FuturoComentario" style="font-size: 32px;">Notas Entierro Futuro</label>
   <?php	wp_editor( $notes_servicioDestino_1FuturoComentario, $this->plugin_name . '_servicioDestino_1FuturoComentario',$args_servicioDestino_1FuturoComentario); ?>
 </li>
 ...
 <li><label for="'.$this->plugin_name._servicioDestino_2FuturoComentario" style="font-size: 32px;">Notas Incineración Futuro</label>
   <?php	wp_editor( $notes_servicioDestino_2FuturoComentario, $this->plugin_name . '_servicioDestino_2FuturoComentario',$args_servicioDestino_2FuturoComentario); ?>
 </li>
 ...
 <li><label for="'.$this->plugin_name._servicioDestino_3FuturoComentario" style="font-size: 32px;">Notas Traslado Futuro</label>
   <?php	wp_editor( $notes_servicioDestino_3FuturoComentario, $this->plugin_name . '_servicioDestino_3FuturoComentario',$args_servicioDestino_3FuturoComentario); ?>
 </li>
 ...
 <li><label for="'.$this->plugin_name._servicioAtaud_1FuturoComentario" style="font-size: 32px;">Notas Ataud Económico Futuro</label>
   <?php	wp_editor( $notes_servicioAtaud_1FuturoComentario, $this->plugin_name . '_servicioAtaud_1FuturoComentario',$args_servicioAtaud_1FuturoComentario); ?>
 </li>
 ...
 <li><label for="'.$this->plugin_name._servicioAtaud_2FuturoComentario" style="font-size: 32px;">Notas Ataud Medio Futuro</label>
   <?php	wp_editor( $notes_servicioAtaud_2FuturoComentario, $this->plugin_name . '_servicioAtaud_2FuturoComentario',$args_servicioAtaud_2FuturoComentario); ?>
 </li>
 ...
 <li><label for="'.$this->plugin_name._servicioAtaud_3FuturoComentario" style="font-size: 32px;">Notas Ataud Premium Futuro</label>
   <?php	wp_editor( $notes_servicioAtaud_3FuturoComentario, $this->plugin_name . '_servicioAtaud_3FuturoComentario',$args_servicioAtaud_3FuturoComentario); ?>
 </li>
 ...
 <li><label for="'.$this->plugin_name._servicioAtaudEcologico_1FuturoComentario" style="font-size: 32px;">Notas Ataud Ecológico Económico Futuro</label>
   <?php	wp_editor( $notes_servicioAtaudEcologico_1FuturoComentario, $this->plugin_name . '_servicioAtaudEcologico_1FuturoComentario',$args_servicioAtaudEcologico_1FuturoComentario); ?>
 </li>
 ...
 <li><label for="'.$this->plugin_name._servicioAtaudEcologico_2FuturoComentario" style="font-size: 32px;">Notas Ataud Ecológico Medio Futuro</label>
   <?php	wp_editor( $notes_servicioAtaudEcologico_2FuturoComentario, $this->plugin_name . '_servicioAtaudEcologico_2FuturoComentario',$args_servicioAtaudEcologico_2FuturoComentario); ?>
 </li>
 ...
 <li><label for="'.$this->plugin_name._servicioAtaudEcologico_3FuturoComentario" style="font-size: 32px;">Notas Ataud Ecológico Premium Futuro</label>
   <?php	wp_editor( $notes_servicioAtaudEcologico_3FuturoComentario, $this->plugin_name . '_servicioAtaudEcologico_3FuturoComentario',$args_servicioAtaudEcologico_3FuturoComentario); ?>
 </li>
 ...
 <li><label for="'.$this->plugin_name._servicioVelatorioFuturoComentario" style="font-size: 32px;">Notas Velatorio Futuro</label>
   <?php	wp_editor( $notes_servicioVelatorioFuturoComentario, $this->plugin_name . '_servicioVelatorioFuturoComentario',$args_servicioVelatorioFuturoComentario); ?>
 </li>
 ...
 <li><label for="'.$this->plugin_name._servicioVelatorioNoFuturoComentario" style="font-size: 32px;">Notas Velatorio No Futuro</label>
   <?php	wp_editor( $notes_servicioVelatorioNoFuturoComentario, $this->plugin_name . '_servicioVelatorioNoFuturoComentario',$args_servicioVelatorioNoFuturoComentario); ?>
 </li>
 ...
 <li><label for="'.$this->plugin_name._servicioDespedida_1FuturoComentario" style="font-size: 32px;">Notas Despedida Sala Futuro</label>
   <?php	wp_editor( $notes_servicioDespedida_1FuturoComentario, $this->plugin_name . '_servicioDespedida_1FuturoComentario',$args_servicioDespedida_1FuturoComentario); ?>
 </li>
 ...
 <li><label for="'.$this->plugin_name._servicioDespedida_2FuturoComentario" style="font-size: 32px;">Notas Despedida Civil Futuro</label>
   <?php	wp_editor( $notes_servicioDespedida_2FuturoComentario, $this->plugin_name . '_servicioDespedida_2FuturoComentario',$args_servicioDespedida_2FuturoComentario); ?>
 </li>
 ...
 <li><label for="'.$this->plugin_name._servicioDespedida_3FuturoComentario" style="font-size: 32px;">Notas Religiosa Futuro</label>
   <?php	wp_editor( $notes_servicioDespedida_3FuturoComentario, $this->plugin_name . '_servicioDespedida_3FuturoComentario',$args_servicioDespedida_3FuturoComentario); ?>
 </li>
