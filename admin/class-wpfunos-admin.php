...
class Wpfunos_Admin {
	...
	*/
	 ...
	 * $type 'day'(same day), 'week'(7 days). 'month'(30 days), 'all'
 	 *
 	 */
	private function wpfunos_stats_date( $cpt, $type = 'day', $status = 'publish', $metakey = '', $metavalue = '', $inicio = '1 March 2021' ){
		$ahora = new DateTime();
		$dia = new DateTime();
		$semana = new DateTime();
		$mes = new DateTime();
	 ...
	 * $funcion 'todo' 'media'
 	 */
	private function wpfunos_graph_linear( $cpt, $type = 'all', $funcion = 'todo', $status = 'publish' ){
		$ahora = new DateTime();
		$dia = new DateTime();
		$semana = new DateTime();
		$mes = new DateTime();
	 ...
	 *				'Servicio' = wpfunos_userNombreSeleccionServicio
 	 */
	private function wpfunos_graph_pie_servicios( $servicio = 'Despedida' ){
		$ahora = new DateTime();
		$array = [];
	 ...
	 *  
	 */
	private function wpfunos_graph_ubicaciones_entradas( $funcion = 'todo' ){
		$ahora = new DateTime(); 
		$cuando = new DateTime();
