...
class Wpfunos_Admin
{
  ...
  public function __construct($plugin_name, $version)
  {
    ...
    add_action('admin_init', array($this, 'registerAndBuildPopupsServicios'));
    ...
    add_action('add_meta_boxes_directorio_amavir', array($this, 'setupdirectorio_amavirMetaboxes'));
    ...
    add_action('save_post_directorio_amavir', array($this, 'savedirectorio_amavirMetaBoxData'));
  ...
  public function addPluginAdminMenu()
  {
    ...
    add_menu_page('Comparador', 'Índice comparador', 'funos_comparador', $this->plugin_name, array($this, 'display_plugin_admin_dashboard'), plugin_dir_url(dirname(__FILE__)) . 'admin/img/funos-logo-01.png', 26);
    ...
    //add_submenu_page('wpfunosconfig', esc_html__('Configuración Popups Servicios WpFunos', 'wpfunos'), esc_html__('Poups servicios', 'wpfunos'), 'administrator', 'wpfunos-popups-servicios', array($this, 'displayPluginAdminPopupsServicios'));
    ...
    add_submenu_page('wpfunosprecios_poblacion', esc_html__('Configuración precios población WpFunos', 'wpfunos'), esc_html__('Configuración precios población', 'wpfunos'), 'funos_landings', 'wpfunos-settingspreciospoblacion', array($this, 'displayPreciosPoblacionSettings'));
  ...
  /**
   * Popups Servicios menu display.
   */
  public function displayPluginAdminPopupsServicios()
  {
    if (isset($_GET['error_message'])) {
      add_action('admin_notices', array($this, 'wpfunosSettingsMessages'));
      do_action('admin_notices', sanitize_text_field($_GET['error_message']));
    }
    require_once 'partials/admin-menu/wpfunos-admin-popups-servicios-display.php';
  }
  ...
  public function registerAndBuildPopupsServicios()
  {
    require_once 'partials/registerAndBuild/wpfunos-admin-registerAndBuildPopupsServicios.php';
  }
  ...
  {
?>
    <p><?php esc_html_e('Si está activo guarda los datos del debug en ficheros en /wp-contenet/uploads/wpfunos-logs/ y los muestra en la pestaña "logs".', 'wpfunos'); ?></p>
  <?php
  }
  public function wpfunos_display_general_account_confimagenes()
  {
  ?>
    <p><?php esc_html_e('Configuración imágenes.', 'wpfunos'); ?></p>
  <?php
  }
  public function wpfunos_display_aseguradoras_account()
  {
  ?>
    <p><?php esc_html_e('Configuración de las aseguradoras.', 'wpfunos'); ?></p>
  <?php
  }
  ...
  {
  ?>
    <p><?php esc_html_e('Plantilla del formulario de datos.', 'wpfunos'); ?></p>
  <?php
  }
  public function wpfunos_display_general_account_resultados()
  {
  ?>
    <p><?php esc_html_e('Cabecera y pie de la página de resultados.', 'wpfunos'); ?></p>
  <?php
  }
  public function wpfunos_display_general_account_confirmado()
  {
  ?>
    <p><?php esc_html_e('Plantilla de resultados confirmados', 'wpfunos'); ?></p>
  <?php
  }
  public function wpfunos_display_general_account_confirmadodescuento()
  {
  ?>
    <p><?php esc_html_e('Plantilla de resultados confirmados con descuento', 'wpfunos'); ?></p>
  <?php
  }
  public function wpfunos_display_general_account_sinconfirmar()
  {
  ?>
    <p><?php esc_html_e('Plantilla de resultados sin confirmar', 'wpfunos'); ?></p>
  <?php
  }
  public function wpfunos_display_general_account_sinprecio()
  {
  ?>
    <p><?php esc_html_e('Plantilla de resultados sin precio', 'wpfunos'); ?></p>
  <?php
  }
  ...
  {
  ?>
    <p><?php esc_html_e('Configuración del directorio.', 'wpfunos'); ?></p>
  <?php
  }
  public function wpfunos_display_direccionesip_account()
  {
  ?>
    <p><?php esc_html_e('Configuración direcciones IP desarrollo.', 'wpfunos'); ?></p>
  <?php
  }
  public function wpfunos_display_precio_poblacion_account()
  {
  ?>
    <p><?php esc_html_e('Configuración precios población.', 'wpfunos'); ?></p>
    <?php
  }
  ...
  //}
  public function setupdirectorio_amavirMetaboxes()
  {
    add_meta_box('directorio_amavir_data_meta_box', esc_html__('Información', 'wpfunos'), array($this, 'directorio_amavir_data_meta_box'), 'directorio_amavir', 'normal', 'high');
  }
  ...
  public function savedirectorio_servicioMetaBoxData($post_id)
  {
    ...
    if (defined('DOING_AUTOSAVE') && DOING_AUTOSAVE) return;
    if (!current_user_can('manage_options')) return;
    require_once 'partials/DB/directorio/wpfunos-admin-DB-directorio-servicio-fields.php';
  }
  public function savedirectorio_entradaMetaBoxData($post_id)
  {
    ...
    if (defined('DOING_AUTOSAVE') && DOING_AUTOSAVE) return;
    if (!current_user_can('manage_options')) return;
    require_once 'partials/DB/directorio/wpfunos-admin-DB-directorio-entrada-fields.php';
  }
  public function savedirectorio_funerariaMetaBoxData($post_id)
  {
    ...
    if (defined('DOING_AUTOSAVE') && DOING_AUTOSAVE) return;
    if (!current_user_can('manage_options')) return;
    require_once 'partials/DB/directorio/wpfunos-admin-DB-directorio-funeraria-fields.php';
  }
  public function savedirectorio_defuncionMetaBoxData($post_id)
  {
    ...
    if (defined('DOING_AUTOSAVE') && DOING_AUTOSAVE) return;
    if (!current_user_can('manage_options')) return;
    require_once 'partials/DB/directorio/wpfunos-admin-DB-directorio-defuncion-fields.php';
  }
  ...
  //}
  public function savedirectorio_amavirMetaBoxData($post_id)
  {
    if (!isset($_POST['wpfunos_directorio_amavir_meta_box_nonce'])) return;
    if (!wp_verify_nonce($_POST['wpfunos_directorio_amavir_meta_box_nonce'], 'wpfunos_directorio_amavir_meta_box')) return;
    if (defined('DOING_AUTOSAVE') && DOING_AUTOSAVE) return;
    if (!current_user_can('manage_options')) return;
    require_once 'partials/DB/directorio/wpfunos-admin-DB-directorio-amavir-fields.php';
  }
  /*********************************/
  /*****  CPT                 ******/
  /*********************************/
  ...
  public function directorio_servicio_data_meta_box($post)
  {
    ...
    require_once 'partials/DB/directorio/wpfunos-admin-DB-directorio-servicio-display.php';
  }
  public function directorio_entrada_data_meta_box($post)
  {
    ...
    require_once 'partials/DB/directorio/wpfunos-admin-DB-directorio-entrada-display.php';
  }
  public function directorio_funeraria_data_meta_box($post)
  {
    ...
    require_once 'partials/DB/directorio/wpfunos-admin-DB-directorio-funeraria-display.php';
  }
  public function directorio_defuncion_data_meta_box($post)
  {
    ...
    require_once 'partials/DB/directorio/wpfunos-admin-DB-directorio-defuncion-display.php';
  }
  ...
  //}
  public function directorio_amavir_data_meta_box($post)
  {
    wp_nonce_field('wpfunos_directorio_amavir_meta_box', 'wpfunos_directorio_amavir_meta_box_nonce');
    require_once 'partials/DB/directorio/wpfunos-admin-DB-directorio-amavir-display.php';
  }
  /*********************************/
  /*****  RENDERS             ******/
  /*********************************/
  ...
  public function wpfunos_render_settings_field($args)
  {
    ...
    ?>
          <input type="<?php esc_html_e($args['subtype']); ?>" id="<?php esc_html_e($args['id']); ?>" <?php esc_html_e($args['required']); ?> name="<?php esc_html_e($args['name']); ?>" size="40" value="1" <?php esc_html_e($checked); ?> />
    <?php
        }
        break;
      default:
