...
class Wpfunos_Public {
  ...
  */
  public function wpfunosFormNewrecord($record, $handler){
    ...
    $userURL= get_site_url() . '/comparar-precios?address%5B%5D=' .esc_url( $fields['address'] ). '&post%5B%5D=' .$fields['post']. '&distance=' .$fields['distance']. '&units=' .$fields['units']. '&page1=&per_page=50&lat=' .$fields['lat']. '&lng=' .$fields['lng']. '&form=4&action=fs&wpf=' .$fields['wpf']. '&orden=precios';
