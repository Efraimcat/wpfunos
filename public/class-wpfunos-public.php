...
class Wpfunos_Public
{
  ...
  public function wpfunosResultadosShortcode($atts, $content = "")
  {
    ...
    switch ($a['boton']) {
      case '2':
        echo ('<span id="wpf-texto-poblacion">' . strtr($respuesta[0], "+", ",") . '</span>');
        break;
      case '8':
        echo ('<span id="wpf-texto-poblacion">' . $respuesta[3] . '</span>');
        break; //Año de nacimiento
    }
  }
  ...
  public function wpfunosFormNewrecord($record, $handler)
  {
    ...
    if ($form_name == 'PaginaFinanciacion') {
      ...
      $transient_ref = get_transient('wpfunos-wpfref-v3-' . $userIP);
