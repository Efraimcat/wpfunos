...
jQuery( document ).ready( function() { //wait for the page to load
  ...
  jQuery( window ).on( 'elementor/frontend/init', function() { //wait for elementor to load
    elementorFrontend.on( 'components:init', function() { //wait for elementor pro to load
      elementorFrontend.documentsManager.documents[document.getElementById("wpf-resultados-cabecera-donde").getAttribute("wpfmultiformcuando")].showModal(); //show the popup
      ...
      var wpfincineracion = function() {
        ...
        document.getElementById("elementor-popup-modal-"document.getElementById("wpf-resultados-cabecera-donde").getAttribute("wpfmultiformdestino")).style.display = "none"
      ...
      document.getElementById("wpfunos-multistep-ahora").addEventListener('click', function() {
        document.getElementById("elementor-popup-modal-"document.getElementById("wpf-resultados-cabecera-donde").getAttribute("wpfmultiformcuando")).style.display = "none"
        elementorFrontend.documentsManager.documents[document.getElementById("wpf-resultados-cabecera-donde").getAttribute("wpfmultiformdestino")].showModal(); //show the popup
        cuando = 'Ahora';
