...
class Wpfunos_Aseguradoras
{
  ...
  public function __construct($plugin_name, $version)
  {
    ...
    add_action('wp_ajax_nopriv_wpfunos_ajax_aseguradoras_llamamos', function () {
      $this->wpfunosAseguradorasLlamamos();
    });
    add_action('wp_ajax_wpfunos_ajax_aseguradoras_llamamos', function () {
      $this->wpfunosAseguradorasLlamamos();
    });
    add_action('wp_ajax_nopriv_wpfunos_ajax_aseguradoras_presupuesto', function () {
      $this->wpfunosAseguradorasPresupuesto();
    });
    add_action('wp_ajax_wpfunos_ajax_aseguradoras_presupuesto', function () {
      $this->wpfunosAseguradorasPresupuesto();
    });
  }
...
?>
    <script>
      console.log('wpfunosAseguradorasResultados. $_GET[referencia]: <?php echo $_GET['referencia']; ?> ');
    </script>
    <?php
    ...
    switch ($respuesta[2]) {
      case '1':
        $sexo = esc_html__('Hombre', 'wpfunos_es');
        break;
      case '2';
        $sexo = esc_html__('Mujer', 'wpfunos_es');
        break;
    }
    ...
    ?>
          <div class="wpfunos-titulo-aseguradoras" id="
    <?php echo str_replace(" ", "-", get_post_meta($IDtipoOrig, 'wpfunos_tipoSeguroDisplay', true)); ?>">
            <p></p>
            <center>
              <h2><?php echo get_post_meta($IDtipo, 'wpfunos_tipoSeguroDisplay', true); ?></h2>
            </center>
          </div>
          <?php
          ?>
          ...
          <?php
          ?>
          <div class="wpfunos-busqueda-contenedor wpfunos-busqueda-contenedor-argumentario">
            <?php
          ...
          ?>
              <div class="wpfunos-busqueda-contenedor">
                <?php
              ...
              wpftelus|' . $telefonoUsuario;
                ...
                ?>
                <div class="wpfunos-busqueda-aseguradoras-inferior" id="wpfunosID-<?php echo $IDaseguradora; ?>">
                  <?php
