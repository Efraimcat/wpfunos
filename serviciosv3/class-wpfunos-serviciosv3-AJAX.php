...
class Wpfunos_ServiciosV3_AJAX extends Wpfunos_ServiciosV3
{
  ...
  {
    add_action('wp_ajax_nopriv_wpfunos_ajax_v3_multiform', function () {
      $this->wpfunosV3Multiform();
    });
    add_action('wp_ajax_wpfunos_ajax_v3_multiform', function () {
      $this->wpfunosV3Multiform();
    });
    add_action('wp_ajax_nopriv_wpfunos_ajax_v3_llamamos', function () {
      $this->wpfunosV3Llamamos();
    });
    add_action('wp_ajax_wpfunos_ajax_v3_llamamos', function () {
      $this->wpfunosV3Llamamos();
    });
    add_action('wp_ajax_nopriv_wpfunos_ajax_v3_llamar', function () {
      $this->wpfunosV3Llamar();
    });
    add_action('wp_ajax_wpfunos_ajax_v3_llamar', function () {
      $this->wpfunosV3Llamar();
    });
    add_action('wp_ajax_nopriv_wpfunos_ajax_v3_presupuesto', function () {
      $this->wpfunosV3Presupuesto();
    });
    add_action('wp_ajax_wpfunos_ajax_v3_presupuesto', function () {
      $this->wpfunosV3Presupuesto();
    });
    add_action('wp_ajax_nopriv_wpfunos_ajax_v3_detalles', function () {
      $this->wpfunosV3Detalles();
    });
    add_action('wp_ajax_wpfunos_ajax_v3_detalles', function () {
      $this->wpfunosV3Detalles();
    });
    add_action('wp_ajax_nopriv_wpfunos_ajax_v3_email', function () {
      $this->wpfunosV3Email();
    });
    add_action('wp_ajax_wpfunos_ajax_v3_email', function () {
      $this->wpfunosV3Email();
    });
    add_action('wp_ajax_nopriv_wpfunos_ajax_v3_dist_local', function () {
      $this->wpfunosV3DistLocal();
    });
    add_action('wp_ajax_wpfunos_ajax_v3_dist_local', function () {
      $this->wpfunosV3DistLocal();
    });

    add_action('wp_ajax_nopriv_wpfunos_ajax_v3_filtros', function () {
      $this->wpfunosV3Filtros();
    });
    add_action('wp_ajax_wpfunos_ajax_v3_filtros', function () {
      $this->wpfunosV3Filtros();
    });

    add_action('wp_ajax_nopriv_wpfunos_ajax_v3_cambiar_datos_usuario', function () {
      $this->wpfunosV3CambiarDatosUsuario();
    });
    add_action('wp_ajax_wpfunos_ajax_v3_cambiar_datos_usuario', function () {
      $this->wpfunosV3CambiarDatosUsuario();
    });
  }
  ...
  public function wpfunosV3Multiform()
  {
    ...
    if ('' != $wpfnombre && '' != $wpfemail && '' != $wpftelefono) {
      ...
      switch ((int)$wpfresp1) {
        case 1:
          $wpfdestino = esc_html__('Entierro', 'wpfunos_es');
          break;
        case 2:
          $wpfdestino = esc_html__('Incineración', 'wpfunos_es');
          break;
      }
      switch ((int)$wpfresp2) {
        case 1:
          $wpfataud = esc_html__('Ataúd medio', 'wpfunos_es');
          break;
        case 2:
          $wpfataud = esc_html__('Ataúd económico', 'wpfunos_es');
          break;
        case 3:
          $wpfataud = esc_html__('Ataúd premium', 'wpfunos_es');
          break;
      }
      switch ((int)$wpfresp3) {
        case 1:
          $wpfvelatorio = esc_html__('Velatorio', 'wpfunos_es');
          break;
        case 2:
          $wpfvelatorio = esc_html__('Sin velatorio', 'wpfunos_es');
          break;
      }
      switch ((int)$wpfresp4) {
        case 1:
          $wpfceremonia = esc_html__('Sin ceremonia', 'wpfunos_es');
          break;
        case 2:
          $wpfceremonia = esc_html__('Solo sala', 'wpfunos_es');
          break;
        case 3:
          $wpfceremonia = esc_html__('Ceremonia civil', 'wpfunos_es');
          break;
        case 4:
          $wpfceremonia = esc_html__('Ceremonia religiosa', 'wpfunos_es');
          break;
      }
      ...
      $codigo_provincia = substr($wpfcp, 0, 2);
      $args = array(
      ...
      if ($post_list) {
        foreach ($post_list as $post) {
          $provincia =  get_post_meta($post->ID, 'wpfunos_provinciasProvincia', true);
        }
      }
      //
      //
      if (!apply_filters('wpfunos_pruebas_email', $wpfemail)) {
        ...
        $phone =  apply_filters('wpfunos_telefono_formateado_hubspot', $Telefono);
        $params = array(
          'firstname' => $wpfnombre,
          'email' => $wpfemail,
          'phone' => $phone,
  ...
  public function wpfunosV3Llamamos()
  {
    ...
    if (!apply_filters('wpfunos_reserved_email', 'wpfunosV3Llamamos')) {
      ...
      switch ($transient_ref['wpfresp1']) {
        case '1':
          $destino = 'E';
          $nombredestino = esc_html__('Entierro', 'wpfunos_es');
          break;
        case '2':
          $destino = 'I';
          $nombredestino = esc_html__('Incineración', 'wpfunos_es');
          break;
      }
      switch ($transient_ref['wpfresp2']) {
        case '1':
          $ataud = 'M';
          $nombreataud = esc_html__('Ataúd medio', 'wpfunos_es');
          break;
        case '2':
          $ataud = 'E';
          $nombreataud = esc_html__('Ataúd económico', 'wpfunos_es');
          break;
        case '3':
          $ataud = 'P';
          $nombreataud = esc_html__('Ataúd premium', 'wpfunos_es');
          break;
      }
      switch ($transient_ref['wpfresp3']) {
        case '1':
          $velatorio = 'V';
          $nombrevelatorio = esc_html__('Velatorio', 'wpfunos_es');
          break;
        case '2':
          $velatorio = 'S';
          $nombrevelatorio = esc_html__('Sin velatorio', 'wpfunos_es');
          break;
      }
      switch ($transient_ref['wpfresp4']) {
        case '1':
          $despedida = 'S';
          $nombredespedida = esc_html__('Sin ceremonia', 'wpfunos_es');
          break;
        case '2':
          $despedida = 'O';
          $nombredespedida = esc_html__('Solo sala', 'wpfunos_es');
          break;
        case '3':
          $despedida = 'C';
          $nombredespedida = esc_html__('Ceremonia civil', 'wpfunos_es');
          break;
        case '4':
          $despedida = 'R';
          $nombredespedida = esc_html__('Ceremonia religiosa', 'wpfunos_es');
          break;
      }
    ...
    $params = array(
      ...
      'serviciotitulo' =>  get_the_title($servicio),
      'servicioempresa' => get_post_meta($servicio, 'wpfunos_servicioEmpresa', true),
      'serviciotelefono' => get_post_meta($servicio, 'wpfunos_servicioTelefono', true),
      'serviciopoblacion' => get_post_meta($servicio, 'wpfunos_servicioPoblacion', true),
      'servicioprovincia' => get_post_meta($servicio, 'wpfunos_servicioProvincia', true),
      'serviciodireccion' => get_post_meta($servicio, 'wpfunos_servicioDireccion', true),
    ...
    if (!apply_filters('wpfunos_reserved_email', 'wpfunosV3Filtros') && !apply_filters('wpfunos_pruebas_email', get_post_meta($wpfidusuario, 'wpfunos_userMail', true))) {
      ...
      switch ((int)$wpfresp2) {
        ...
        case 2:
          $wpfataud = esc_html__('Ataúd económico', 'wpfunos_es');
          $hcampo = 'ataud';
          $hvalor = 'Ataúd económico';
          break;
        case 3:
          $wpfataud = esc_html__('Ataúd premium', 'wpfunos_es');
          $hcampo = 'ataud';
          $hvalor = 'Ataúd premium';
          break;
      }
      switch ((int)$wpfresp3) {
        case 1:
      ...
      switch ((int)$wpfresp4) {
        ...
        case 3:
          $wpfceremonia = esc_html__('Ceremonia civil', 'wpfunos_es');
          $hcampo = 'ceremonia';
          $hvalor = 'Ceremonia civil';
          break;
        case 4:
          $wpfceremonia = esc_html__('Ceremonia religiosa', 'wpfunos_es');
          $hcampo = 'ceremonia';
          $hvalor = 'Ceremonia religiosa';
          break;
      }
      if ($hubspotutk == '') $hubspotutk = 'fe23' . apply_filters('wpfunos_generate_random_string', 28);
      $my_post = array(
